...
class ResearchProject(models.Model):
    ...
    abstract = models.TextField()  # Written abstract
    ...
    # Optional Fields
    github_link = models.URLField(null=True, blank=True)  # GitHub Repository
    project_sponsor = models.CharField(
        max_length=255, null=True, blank=True
    )  # Sponsor organization or company
    poster_image = models.ImageField(
        upload_to="posters/", null=True, blank=True
    )  # Research poster image
    video_link = models.URLField(null=True, blank=True)  # Video Presentation Link
